...
public class Railways extends JFrame implements ActionListener {
            ...
            try {
                if (daddress.equals("")) {
                    JOptionPane.showMessageDialog(null, "Fill all the required fields");
                     ...
                     Conn c = new Conn();
                    String q3 = "insert into railways values('" + formno + "','" + name + "','" + mobno + "','" + dob + "','" + email + "','" + cargoWeight + "','" + saddress + "','" + spin + "','" + daddress + "','" + dpin + "')";
